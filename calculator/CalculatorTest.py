...
class CalculatorTest(unittest.TestCase):
    ...
    def test_add_string_and_value_return_exception(self):
        ...
        a="string"
        b=234
        self.assertRaises(Exceptions.Not_A_Number,calc.add, a, b)
    ...
    def test_division_value_and_string_return_exception(self):
        ...
        a=31
        b="string"
        self.assertRaises(Exceptions.Not_A_Number,calc.division, a, b)
    ...
    def test_division_by_zero_return_exception(self):
        ...
        a = 123
        b = 0
        self.assertRaises(Exceptions.Not_A_Possible_Denominator, calc.division, a, b)
    ...
    def test_logarithm_of_string_and_value_return_exception(self):
        ...
        a = "string"
        b = 123
        self.assertRaises(Exceptions.Not_A_Number, calc.logarithm, a, b)
    ...
    def test_logarithm_of_basis_lower_than_0_return_exception(self):
        ...
        a = -5
        b = 25
        self.assertRaises(Exceptions.Not_A_Possible_Basis, calc.logarithm, a, b)
    ...
    def test_logarithm_of_value_lower_than_0_return_exception(self):
        ...
        a = 5
        b = -25
        self.assertRaises(Exceptions.Not_A_Positive_Value, calc.logarithm, a, b)
